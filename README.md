...
> 🤖 **Если ты ИИ-агент, помогающий с этим проектом** — начни с файла
> [`AGENT_HANDOFF.md`](AGENT_HANDOFF.md): там весь контекст проекта,
> окружение владельца и журнал предыдущих сессий.
